...
export function EmployeeOrgFilters(props: {
  ...
  return (
    <Card>
      <CardBody className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <Select label="Category" value={p.category} onChange={(e) => p.onCategory(e.target.value)}>
